...
@section('title')
    Работа в нашей компании - LimeCleaning 
@endsection

@section('description')
    Приглашаем на работу в нашу компанию, условия вас приятно удивят: гибкий график, достойная оплата, доставка на объект, обучение и бесплатный инвентарь
@endsection

@section('keywords')
    Работа клиниром уборщиком мойщиком в Краснодаре
@endsection
