            ...
            <div class="content__miniblock miniblock">
                <div class="miniblock__single">
                    <div class="miniblock__wrap">
                        ...
                        <div class="miniblock__text">
                            Не нужно ежедневно сидеть на работе с 9.00 до 18.00. Часы работы и интенсивность графика зависят от вас.
                        </div>
                        <!-- /.miniblock__text -->
                    </div>
                </div>
                ...
                <div class="miniblock__single">
                    <div class="miniblock__wrap">
                        ...
                        <!-- /.miniblock__title -->
                        <div class="miniblock__text">
                            После приема на работу вы пройдете обучение: научитесь правилам поведения в квартире клиента, работе с профессиональной техникой и моющими средствами.
                        </div>
                        <!-- /.miniblock__text -->
                    </div>
                </div>
