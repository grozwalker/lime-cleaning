                ...
                <div class="description__model tabs">
                    ...
                    <div class="tabs__desc tabs_active tabs_content_alpinism">
                        ...
                        <div class="tabs__description">
                            ...
                            <p>
                                Компания Lime Cleaning работает только с профессиональными сертифицированными альпинистами. Для каждого объекта альпинисты индивидуально подбирают снаряжение, оборудование и средства для мойки. Поэтому стоимость и сроки работы оговариваются отдельно для каждого объекта.
                            </p>
                        </div>
                        <!-- /.tabs__description -->
                    </div>
                    ...
                    <div class="tabs__desc tabs_content_fromground">
                        ...
                        <div class="tabs__description">
                            <p>
                                Технология подачи воды через телескопические штанги делает мойку фасадов еще проще и доступнее. Суть этой технологии проста: работник с земли управляет длинной (до 21 метра)
                            </p>
                            <p>
