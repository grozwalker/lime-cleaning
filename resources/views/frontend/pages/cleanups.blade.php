...
@section('title')
    Уборка квартир, домов, коттеджей в Краснодаре. Генеральная уборка и клининг после ремонта - LimeCleaning 
@endsection

@section('description')
    В нашей компании вы можете заказать генеральную уборку квартиры или дома, так же вы можете узнать стоимость на уборку помещений после ремонта в Краснодаре. Вас приятно удивят цены на уборку офисных помещений в Краснодаре.
@endsection

@section('keywords')
    Уборка клининг генеральная после ремонта квартир офисов домов коттеджей помешщений складов Краснодар 
@endsection
    ...
    <div class="banner cleanups cleanups_type_flat">
        <div class="banner__filter filter filter_opacity">
            <div class="banner-wrap">
                <h1 class="top-title">
                    Уборка квартир, домов, <br>
                    коттеджей в Краснодаре
                </h1>
