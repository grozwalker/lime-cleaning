...
персонал" class="mini-block__img">
                    ...
                    <div class="why-us__text">
                        <p>Согласитесь, очень приятно, когда в квартире чистота и порядок,
                            все красиво и сверкает. Плохо только то, что сегодня очень сложно
                            найти время для генеральной уборки, все постоянно заняты, то работают,
                            то отдыхают. Для любителей идеальной чистоты, есть возможность
                            заказать генеральную уборку квартиры от профессионалов в компании
                            Qlean.</p>
                        <p>Генеральная уборка — это необходимое, но в то же время очень
                            хлопотное занятие. Дабы в доме было чисто, нужно проделывать
                            генеральную уборку квартиры в Москве хотя бы несколько раз в году.
                            На комплексную уборку так же часто не хватает время, так что люди
                            начинают доверять ее профессионалам, таким как мы.</p>
                    </div>
            ...
            <div class="clean-block">
                ...
                <div class="clean-block__r-b">
                    ...
                    <div class="clean-block__list">
                        <ul class="lime-list">
                            <li class="lime-list__item">
                                <span>Моем душевую кабинку и ванную</span>
                            </li>
                            <!-- /.lime-list__item -->
                            <li class="lime-list__item">
