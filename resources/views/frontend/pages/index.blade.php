...
@section('content')
    <section class="advantages">
        ...
        <div class="advantage">
            ...
            <div class="advantage__desc">
                У нас работают только опытные сотрудники, <br>
                прошедшие строгий отбор. Мы ценим доверие<br>
                клиентов и гарантируем<br>
        ...
        <div class="advantage">
            ...
            <div class="advantage__desc">
                Мы используем <a class="advantage__link" href="#">профессиональную<br>
                    чистящую технику и специальные моющие средства</a><br>
