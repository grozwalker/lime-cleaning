        ...
        <div class="banner__filter filter filter_opacity">
            <div class="banner-wrap">
                ...
                <h2 class="top-subtitle">
                    Закажите уборку <span>от 1500 &#8381;</span>
                </h2>
                <!-- /.top-subtitle -->
                <!--onsubmit="order()" -->
    ...
    <section class="advantages">
        <div class="advantage">
            ...
            <div class="advantage__desc">
                Мы ответственно подходим <br>
                к своей работе, и <a class="advantage__link" href="#"> гарантируем <br>
                    результат</a>, ктотрым <br>
                вы останетесь довольны <br>
            </div>
        </div>
        <!-- /.advantage -->
        <div class="advantage">
            ...
            <div class="advantage__desc">
                Каждый член нашей команды <br>
                проходит <a class="advantage__link" href="#">ряд проверок <br>
                    и испытаний</a>, доверие наших <br>
                клиентов на первом месте <br>
            </div>
        </div>
        <!-- /.advantage -->
        <div class="advantage">
            ...
            <div class="advantage__desc">
                Используем <a class="advantage__link" href="#">профессиональную <br>
                    технику и моющие средства</a>, <br>
                безопасные и обладающие <br>
                гипоаллергенными свойствами <br>
            </div>
        </div>
        <!-- /.advantage -->
    </section>
                ...
                <div class="trust-item  bg_right trust_cleaner">
                    <div class="trust-item__wrap">
                        ...
                        <div class="trust-item__desc">
                            Отбор клинеров проходит в несколько
                            этапов — собеседование, тестирование,
                            проверка службой безопасности. С нами
                            остаются только лучшие из лучших.
                        </div>
                    </div>
                    <!-- /.trust-item__wrap -->
                </div>
                <div class="trust-item bg_left trust_protected">
                    <div class="trust-item__wrap">
                        ...
                        <div class="trust-item__desc">
                            ...
                            а для оплаты используем только
                            безопасные каналы. Мы не храним данные
                            банковских карт, а для оплаты используем
                        </div>
                    </div>
                    <!-- /.trust-item__wrap -->
                </div>
            ...
            <div class="r-column">
                <div class="trust-item bg_right trust_responsibility ">
                    <div class="trust-item__wrap">
                        ...
                        <div class="trust-item__desc">
                            Если что-то пошло не так, мы оперативно
                            решаем вопросы и исправляем
                            недоразумения. если такие возникают,
                ...
                <div class="trust-item bg_left trust_trace">
                    ...
                    <div class="trust-item__desc">
                        Вы оцениваете работу уборщиков
                        по пятибалльной шкале, а мы следим, чтобы
                        они всегда делали свою работу на отлично,
        ...
        <div class="reviews-wrapper">
            ...
            <div class="review">
                ...
                <div class="review__text">
                    <p>
                        «Последние несколько месяцев регулярно заказываю уборку в Lime Cleaning. Приезжают вовремя,
                        убирают чисто, а главное в случае каких либо проблем я всегда знаю куда обращаться.
                        Это гораздо удобнее и проще чем связываться с частниками.
            ...
            <div class="review">
                ...
                <div class="review__text">
                    <p>
                        «Спасибо, что есть такая отличная компания. Ни один раз заказывал генеральную уборку квартиры, всегда остаюсь очень доволен качеством, скоростью и ценой!»
                    </p>
                </div>
            </div>
            <!-- /.review -->
